...
public class Auto {
	...
	public Auto(String mode){ 
		...
		Apara1NonCon.add(new ActionSetIntake(0.4));
		...
		Bpara1NonCon.add(new ActionSetIntake(0.8));
		...
		Cpara3NonCon.add(new ActionSetIntake(1));
